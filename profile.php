...
<head>
    ...
    <title>Home Realtime <?php echo $fetched_user->getPropertyValue("username"); ?></title>
    ...
    <style>
        /* <!-- responsive  for an android--> */
        @media  screen and (max-width:480px){
            .button-style-2{
                margin-top: -2cm;
                margin-inline-start: -13cm;
                width: 3cm;
            }
            #first-section{
                width: 544px;
    ...
    @media screen and (min-device-width:640px) and (max-device-width:2000px) and (orientation:portrait) {
            #first-section{
                width: 768px;
                margin-top: 1cm;
                ...
                <div id="profile-picture-container">
                    <div class="relative picture-back-color" style="border-radius: 50%; overflow: hidden">
                        <div class="profile-picture-cnt">
                            <img src="<?php echo $profile_user_picture; ?>" class="profile-picture" alt="public/assets/images/favicons/shriram.png">
                        </div>
