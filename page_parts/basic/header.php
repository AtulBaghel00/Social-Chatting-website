...
<header>
    <div id="top-header">
        <div id="header-logo-container">
            ...
            <a href="<?php echo Config::get("root/path");?>index.php" style="height: 28px"><img src="<?php echo Config::get("root/path");?>public/assets/images/logos/shriram.png" alt="Logo" id="header-logo"></a>
        </div>
        ...
        <div id="global-header-strip-container">
            <div class="row-v-flex header-menu">
                ...
                <div class="horizontal-menu-item-wrapper">
                    <a href="<?php echo Config::get("root/path");?>live.php"  class="horizontal-menu-link menu-button-style-1 live-button">Live</a>
                </div>
            </div>
            <div class="menu-items-separator"></div>
            <div class="row-v-flex header-menu">
